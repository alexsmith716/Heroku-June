	...
	return (
		<div className="row-flex">
			...
			<div className="col-ten">
				...
				<div>
					<b>Status:&nbsp;</b>
					{character.status ? character.status : <i>n/a</i>}
				</div>

				<div>
					<b>Species:&nbsp;</b>
					{character.species ? character.species : <i>n/a</i>}
				</div>

				<div>
					<b>Type:&nbsp;</b>
					{character.type ? character.type : <i>n/a</i>}
				</div>

				<div>
					<b>Gender:&nbsp;</b>
					{character.gender ? character.gender : <i>n/a</i>}
				</div>

				<div>
					<b>ID:&nbsp;</b>
					{character.id ? character.id : <i>n/a</i>}
				</div>
			</div>
		</div>
	);
